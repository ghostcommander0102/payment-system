                ...
                <div class="right">
                    ...
                    {{ Form::open(['route' => 'signUpProcess', 'files' => true]) }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="bank_name" value="{{old('bank_name')}}" class="form-control" placeholder="{{__('Your bank name')}}">
                        ...
                        <div class="form-group">
                            <label>{{__('Bank Account Title')}}<span class="text-danger">*</span></label>
                            <input type="text" name="bank_account_title" value="{{old('bank_account_title')}}" class="form-control" placeholder="{{__('Your account title')}}">
                            @if ($errors->has('bank_account_title'))
                                <p class="invalid-feedback">{{ $errors->first('bank_account_title') }} </p>
                            @endif
                        </div>
                          ...
                          <div class="form-group">
                            <label>{{__('Bank Account Number')}}<span class="text-danger">*</span></label>
                            <input type="text" name="bank_account_number" value="{{old('bank_account_number')}}" class="form-control" placeholder="{{__('Your bank account number')}}">
                            @if ($errors->has('bank_account_number'))
                                <p class="invalid-feedback">{{ $errors->first('bank_account_number') }} </p>
                            @endif
                        </div>
                        
                            <div class="form-group">
                            <label>{{__('Phone Number(Wihout country code)')}}<span class="text-danger">*</span></label>
                            <input type="text" name="phone_number" value="{{old('phone_number')}}" class="form-control" placeholder="{{__('Your bank account number')}}">
                            @if ($errors->has('bank_account_number'))
