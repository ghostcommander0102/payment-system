                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-7">
                                            ...
                                            <div class="alert alert-info" role="alert">
                                                @if($type == 'buyer')
                                                    {{__('Don’t pay the seller until they put ')}} {{$item->coin_type}} {{__(' in escrow. Once escrowed, this status will change.')}}
                                                @else
                                                    {{__('Before accepting payment, you must put the ')}} {{$item->coin_type}} {{__(' into a secure escrow account.')}}
                                                @endif
                                            </div>
                                                ...
                                                @else
                                                    ...
                                                    <div class="col-md-4 col-lg-3">
                                                        <p class ="trade-step @if($item->status == TRADE_STATUS_ESCROW || $item->status == TRADE_STATUS_PAYMENT_DONE || $item->status == TRADE_STATUS_TRANSFER_DONE) step-complete @endif">
                                                            {{__('Seller puts ')}} {{$item->coin_type}} {{__(' in escrow')}}
                                                        </p>
                                                    </div>
                                                    <div class="col-md-4 col-lg-3">
                                                ...
                                                <div class="col-12">
                                                    <div class="cp-user-card-header-area">
                                                        <div class="title">
                                                            ...
                                                            <h4 id="list_title2">{{number_format(($item->amount),8).' '.$item->coin_type }}</h4>
                                                            <h4 id="list_title2">{{__('for')}}</h4>
                                                            <h4 id="list_title2">{{ $item->currency .' '.number_format($item->price,8) }}</h4>
                                                            <h4 id="list_title2">1 {{ $item->coin_type .' = '.$item->currency .' '.number_format($item->rate,8) }}</h4>
                                                            <h4 id="list_title2"> {{ __('Fees') .' = '.number_format($item->fees,8).' '.$item->coin_type }}</h4>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    @if($item->status == TRADE_STATUS_TRANSFER_DONE)
                                                        <div class="cp-user-card-header-area">
                                                            <div class="title">
                                                                <h4 id="list_title2">{{__('Transaction Successful')}}</h4>
                                                            </div>
                                                        </div>
                                                    @endif
