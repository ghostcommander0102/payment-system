                        ...
                        <div class="cp-user-coin-info">
                                        ...
                                        <select name="coin_type" class=" form-control" >
                                            @if(isset($coins[0]))
                                                @foreach($coins as $coin)
                                                    <option @if(isset($coins_type) && $coins_type == $coin->type) selected @endif value="{{$coin->type}}">{{$coin->type}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-sm-12">
                                    <div class="cp-user-card-header-area">
                                        <div class="title">
                                            <h4 id="list_title">{{__('Buy ')}} {{$coins_type}} {{__(' from these sellers')}}</h4>
                                        </div>
                                    </div>
                                                            ...
                                                            <h4>{{__('Payment System')}}</h4>
                                                                ...
                                                                <ul>
                                                                    @foreach($sell->payment($sell->id) as $sell_payment)
                                                                        @if($country == 'any')
                                                                            <li>
                                                                                <span><img src="{{$sell_payment->payment_method->image}}" alt=""></span>
                            ...
                            <div class="row mt-4">
                                <div class="col-sm-12">
                                    <div class="cp-user-card-header-area">
                                        <div class="title">
                                            <h4 id="list_title">{{__('Sell ')}} {{$coins_type}} {{__(' to these sellers')}}</h4>
                                        </div>
                                    </div>
                                    <div class="cp-user-wallet-table table-responsive buy-table crypto-exchange-table">
                                        <table class="table">
                                                                ...
                                                                @if(isset($buy->payment($buy->id)[0]))
                                                                    <ul class="payment-system-list">
                                                                        @foreach($buy->payment($buy->id) as $buy_payment)
                                                                            @if($country == 'any')
                                                                                <li>
                                                                                    <span><img src="{{$buy_payment->payment_method->image}}" alt=""></span>{{ $buy_payment->payment_method->name}}
                                                                                </li>
