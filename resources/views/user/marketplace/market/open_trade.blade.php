                                    ...
                                    <div class="row">
                                        <div class="col-xl-4">
                                            ...
                                            <div class="cp-user-payment-type">
                                                ...
                                                <label class="text-warning">{{$offer->coin_type}}</label><input name="amount" id="tradeamount" class="form-control" placeholder="">
                                                        ...
                                                        <ul>
                                                            @if(is_accept_payment_method($pmethod->payment_method_id,$country))
                                                                <li class="text-warning">
                                                                    <span><img src="{{$pmethod->payment_method->image}}" alt=""></span>
