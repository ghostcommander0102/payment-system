                                            ...
                                            <div class="form-groups">
                                                @if(isset($coins[0]))
                                                    @foreach($coins as $coin)
                                                        <div class="form-group">
                                                            <input type="radio" onclick="call_coin_payment();" @if(old('coin_type') == $coin->type) checked @endif  value="{{$coin->type}}" id='{{"coin-option".$coin->id}}' name="coin_type">
                                                            <label for='{{"coin-option".$coin->id}}'>{{$coin->type}}</label>
                                                        </div>
                                                    @endforeach
                                                @else
                                ...
                                <div class="row">
                                    <div class="col-xl-6 mb-xl-0">
                                        ...
                                        <div class="cp-user-payment-type dynamic_rate dynamic_coin_rate d-none">
                                            ...
                                            <div class="form-group">
                                                <input type="radio" onclick="call_coin_payment();" value="{{RATE_ABOVE}}" id="rate_above" name="price_type">
                                                <label for="rate_above">{{__('Above')}}</label>
                                            </div>
                                            <div class="form-group">
                                                <input type="radio" onclick="call_coin_payment();" value="{{RATE_BELOW}}" id="rate_below" name="price_type">
