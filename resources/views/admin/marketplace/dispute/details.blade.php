                ...
                <div class="profile-info-table">
                    <ul>
                        ...
                        <li>
                            ...
                            <span class="dot">:</span>
                            <span><strong>{{$item->coin_type}}</strong></span>
                        </li>
                        <li>
                            <span>{{__('Payment method')}}</span>
                            <span class="dot">:</span>
                            <span>
                                <img src="{{$item->payment_method->image}}" alt="">
                ...
                <div class="profile-info-table">
                    <ul>
                        ...
                        <li>
                            ...
                            <span class="dot">:</span>
                            <span><strong>{{$item->amount.' '.$item->coin_type}}</strong></span>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <span class="dot">:</span>
                            <span><strong>{{$item->fees.' '.$item->coin_type}}</strong></span>
                        </li>
                        <li>
